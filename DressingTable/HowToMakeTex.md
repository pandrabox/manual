...
- DressingTableは既存のテクスチャに化粧を追加するアセットです。そのためのテクスチャ作成方法の一例です。すべて無料。
...
- gimpからエクスポートしているものが出来上がった画像そのものなので、それをDressingTableのTexにセットすることで使うことができます。インポートするときアルファの設定をしたほうがいいですが、しなくても大丈夫なようです。
